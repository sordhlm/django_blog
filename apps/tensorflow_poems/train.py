...
#tf.app.flags.DEFINE_string('model_dir', os.path.abspath('./model_debug'), 'model save path.')
#tf.app.flags.DEFINE_string('file_path', os.path.abspath('./data/poems_debug.txt'), 'file name of poems.')
